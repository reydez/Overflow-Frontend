...
const Formulario = styled.form`
    ...
    border: solid 2px ${colores.inputBlue};
...
const Input = styled.input`
    ...
    &:focus{
        border: 2px solid ${colores.inputBlue};
        outline: none;
...
const CheckInput = styled.input`
    ...
    width: 1.15em;
    height: 1.15em;
    border: 0.15em solid ${colores.inputBlue};
    ...
    &::before{
        ...
        background-color: ${colores.inputBlue};
    }
    &:checked::before {
        transform: scale(1);
    }
    &:focus {
        outline: max(2px, 0.15em) solid ${colores.inputBlue};
