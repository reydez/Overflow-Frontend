...
import { Grid, Paper, Typography, Chip, Stack, Avatar, Link, Button } from "@mui/material";
...
export const QuestionCardNormalUser = ({ question }) => {
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm container>
                    ...
                    <Grid>
                        ...
                        >
                            <Favorite sx={activeColor.favorite ? { color: "#D81B60" } : { color: "#A8A3B5" }} />
                        </Button>
                        <br />
                        {/* ----------------- ELIMINAR PREGUNTA -----------------------*/}
...
export default QuestionCardNormalUser